...
switch (lenguaje) {
  ...
  case 'aimara':
    ...
    break
  default:
    console.log('No conozco el lenguaje')
}
...
function miFuncion(){
    //el bloque codigo a ejecutar
}

// llamado / ejecucion de una funcion 

miFuncion()

//fuciones sin retorno

/function esMayorOMenorDeEdad(){
    if(edad >= 18){
        console.log('mayor de edad')
    }else{
        console.log('menor de edad')
