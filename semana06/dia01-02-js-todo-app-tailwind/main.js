...
taskAdd.addEventListener('click', function(event) {
  ...
  //TODO: Valida la entrada del usuario para que no agregue tareas vacias
...
taskList.addEventListener('click', function(event){
    ...
    //todo: al hacer clic en el checkbox en el texto de la tarea debe tacharse
    // ayuda css: "text-decoration: line-through"

    if(target.tagName === 'INPUT' && target.type === 'checkbox'){

        //aqui target seria el checkbox seleccionado
